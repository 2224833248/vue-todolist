			...
			<view class="cont">
				...
				<view class="btnBox">
					<view class="btns" @click="ckFollow">
						<life-follow class="taskguanzhucomplete__ft" :sceneId="dataList[0].life_id!=''?dataList[0].life_id:dataList[0].appid"  @close.native="lifeClose" :checkFollow="!showHide"/>
						
						<view class="isFollowed" v-if="followed==2">
							已关注
						</view>
						<!-- <image src="../../static/newImg/btngif.gif" mode="widthFix"></image> -->
					</view>
				</view>
