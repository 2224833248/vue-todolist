<template>
	<view class="tBody">
		<view class="banner">
			<view class="myGold">
				<view class="left">
					<view class="name">我的{{type == 'babance'?'金额':'金币'}}</view>
					<view class="money">{{type == 'babance'?user.funcard_money:user.funcard_integral}}</view>
				</view>
				<view class="btns" @click="toClick">{{btnText}}</view>
			</view>
		</view>

		<view class="cont">
			<view class="cont-title">{{type == 'babance'?'金额':'金币'}}明细</view>
			<view class="cont-list">
				<view class="cont-list-item" v-for="(item,index) in record" :key='index'>
					<view class="dateTitle">
						<view class="title">{{type == 'babance'?item.descr:item.typeName}}</view>
						<view class="date">{{item.addtime}}</view>
					</view>
					<view class="gold">
						<text>{{type == 'babance'?item.money:item.integral}}</text>
						<image v-if="type != 'babance'" src="/static/index/gold.png" mode="widthFix"></image>
					</view>
				</view>
