	...
	<view>
		<view class="task__body">
			<view class="task-list">
							...
							<view class="item__info__hd">
								...
								<view class="item__info__hd__subtitle item__info__hd__subtitle--gold">
									<template v-if="item.reward_type=='1'">
										<image :lazy-load="true" src="/static/index/gold.png" mode="aspectFill"></image>
				...
				<!-- <view class="task__list__item" v-for="(item,index) in taskList" :key="index">
				<view class="item__left">
					<view class="">
						<view class="item__left__header">
							<text class="item__left__header__title">{{item.title}}</text>
							<image :lazy-load="true" class="item__left__header__image" src="https://coubei.oss-cn-hangzhou.aliyuncs.com/uniapp/my/golds.png"
