<template v-if="Object.keys(redBase).length > 0">
	<view class="red-box">
		<view class="tabs-box">
			...
			<view class="tabs-box-r">
				<view class="list" v-for="(item,index) in redBase" :key="index" :class="thisActive ==item.title?'active':''"
				 @click="onRedList(item)">
