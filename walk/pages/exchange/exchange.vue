<template>
	<div class="main">
		<view class="inform">
			<uni-notice-bar showIcon='true' single='true' scrollable="true" text="由于系统升级，走路钱多多中金币全部转到“天天夺宝”小程序，若发现金币数量不正确，请到“天天夺宝”小程序查看"></uni-notice-bar>
		</view>
		<div class="block header">
			<div class="line">
				<div class="item">
					<span class="tip">可兑换多多币<span class="num">(10000=1元)</span></span>
				</div>
				<div class="exchange">
			...
			<div class="info">
				<div class="item">
					<span class="title">今日多多币</span>
					<span class="value">{{today}}</span>
				</div>
				<div class="item">
					<span class="title">累计多多币</span>
				...
				<swiper-item v-for="(item,index) in tabList" :key="index">
					<div class="list">
						<template v-if="index==0">
							<mescroll-uni :ref="'mescroll'+index" @init="mescrollInit" @down="downCallback" :up="up" :down="down" @up="upCallback">
						...
						<template v-else>
							<mescroll-uni :ref="'mescroll'+index" @init="mescrollInit" @down="downCallback" :up="up1" :down="down" @up="upCallback">
								<div v-for="(item,index) in exchangeList" class="exchange-item" :key="index">
									<div class="top">
										<div class="label">
											<div class="quan"></div>
											<span class="text">{{item.title}}({{item.integral}}多多币)</span>
										</div>
									</div>
									<div class="bottom">
...
<script>
	...
	export default {
		components: {uniNoticeBar,WucTab},
		...
		methods: {
			...
			getTab(e) {
				if (this.$refs.mescroll0[1].viewId == e.viewId) {
					return 0;
				} else {
					return 1;
				}
