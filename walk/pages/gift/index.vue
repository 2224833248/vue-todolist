		...
		<mescroll-uni ref="mescroll" @init="mescrollInit" @down="downCallback" :up="up" :down="down" @up="upCallback">
			<view class="user_box">
				<view class="integral-box">
					<view class="box-list">
						<text calss="title">我的多多币</text>
					</view>
					<view class="box-list two">
						<image src="https://coubei.oss-cn-hangzhou.aliyuncs.com/uniapp/gift/mon.png"></image>
						<text class="integral">{{user.walk_integral}}</text>
					</view>
				</view>
				<view class="icon-box">
					<view class="list" @click="onIndexTap()">
						<image src="https://coubei.oss-cn-hangzhou.aliyuncs.com/uniapp/gift/yellows.png"></image>
						<text class="name">去赚多多币</text>
					</view>
					<view class="list" @click="onLogTap()">
						<image src="https://coubei.oss-cn-hangzhou.aliyuncs.com/uniapp/gift/huan.png"></image>
